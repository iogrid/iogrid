 ...
 * column. Founder picked Option A (#470) — header-mounted dropdown
 * matches Linear's workspace switcher / Vercel's project switcher /
 * Notion's sidebar-top selector. Single left pane (PersonaSidebar)
 * remains for section sub-nav.
 *
 * Keyboard: arrow keys via natural <Link> tabindex; Escape closes.
 */
