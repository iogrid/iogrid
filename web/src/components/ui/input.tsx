...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        // Re-themed to design-tokens (border / muted-foreground / ring)
        // so the input matches the new restrained palette and inherits
        // dark-mode flips without per-call-site edits.
        className={cn(
