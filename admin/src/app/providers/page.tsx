...
/**
 * /providers — list every paired provider in the pool + audit any one
 * of them via the transparency feed. The list calls providers-svc
 * .ListProviders through the BFF; the audit reuses
