...
|  |  |
|---|---|
| Last refreshed | `2026-06-11T19:30Z` 🟡 hand-update (G2 host-OS wall found: Sonoma can't run Xcode 26; founder chose prove-pipeline-now w/ Sonoma+16.2 — BAKE RUNNING; #736 wallet test) |
