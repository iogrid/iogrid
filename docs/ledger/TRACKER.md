...
|  |  |
|---|---|
| Last refreshed | `2026-06-11T13:30Z` 🟡 hand-update (G1 MAJOR NARROWING: server path now PROVEN working for the founder's real sessions — failure is CLIENT-side startTunnel; #729 ships the diagnostic) |
