...
|  |  |
|---|---|
| Last refreshed | `2026-05-23T12:53Z` 🟢 admin-auth-bootstrap.sh + runbook shipped — idempotent NextAuth + DrizzleAdapter wire for fresh provs. Re-ran live: 1/6 HTTP 200. #475/#476 captured. Open: 67. |
