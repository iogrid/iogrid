...
|  |  |
|---|---|
| Last refreshed | `2026-05-23T09:48Z` 🟢 Persona-switcher dropdown shipped (Closes #470, founder picked Option A after ASCII wireframes). 22 walks landed. Workloads-svc rebuild in flight to recover Dispatch route. |
