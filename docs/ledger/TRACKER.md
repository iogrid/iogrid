...
|  |  |
|---|---|
| Last refreshed | `2026-06-11T12:40Z` 🔴 hand-update (CORRECTION: G1 build 172 STILL FAILS on device — #721 did NOT fix it; G2 architecture DECIDED ADR 0001; G3 complete) |
