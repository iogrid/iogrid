...
|  |  |
|---|---|
| Last refreshed | `2026-06-12T12:10Z` 🟢 hand-update (G3 BOTH ledgers off $0: earnings 15¢/5 builds + on-chain grid_build_settlement 0.425 $GRID provider share; on-chain TRANSFER blocker found+fixed #747; G1 tunnel diagnosed to daemon/session-lifecycle (not network); G2 builds run) |
