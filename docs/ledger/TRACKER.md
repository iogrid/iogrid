...
|  |  |
|---|---|
| Last refreshed | `2026-06-11T17:10Z` 🟢 hand-update (G2 bake pipeline LIVE: base 50% pulled + Xcode-26 mirror running + bake script wired; build 173 on TestFlight awaiting diagnostic) |
