...
|  |  |
|---|---|
| Last refreshed | `2026-05-23T13:05Z` 🟢 admin-auth-bootstrap.sh now ships NextAuth schema too (user/account/session/verificationToken). Fully one-command admin bring-up verified live. |
