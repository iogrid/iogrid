...
|  |  |
|---|---|
| Last refreshed | `2026-06-12T20:30Z` 🟢 hand-update (G3 full earnings loop PROVEN ON-CHAIN — build earning settled, tx confirmed, wallet 10 $GRID; G1 daemon data-plane restored durable + build 179 diagnostic on TestFlight; G2 daemon-orchestrated Tart provider architecture committed) |
