...
| TC-16 | web (public) | Live status dashboard | 🟢 PASS — per-service SLO rows all Operational + incidents + 30s refresh ([#674](https://github.com/iogrid/iogrid/issues/674) closed, indep-ACCEPT; [📷](evidence-web/674-status-dashboard-live.png)); uptime strips follow ([#689](https://github.com/iogrid/iogrid/issues/689)) |
