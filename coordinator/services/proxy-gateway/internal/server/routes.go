// Package server holds the HTTP route definitions for the proxy-gateway microservice.
//
// Customer-facing SOCKS5/HTTP CONNECT proxy on proxy.iogrid.org:443.
//
...
// Mount attaches the proxy-gateway routes onto the shared chi router. Called by main()
