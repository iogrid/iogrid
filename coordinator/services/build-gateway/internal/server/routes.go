// Package server holds the HTTP route definitions for the build-gateway microservice.
//
...
// Mount attaches the build-gateway routes onto the shared chi router. Called by main()
