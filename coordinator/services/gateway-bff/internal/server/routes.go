// Package server holds the HTTP route definitions for the gateway-bff microservice.
//
// Backend-for-Frontend for the Next.js management plane (aggregation + SSE/WebSocket).
//
...
// Mount attaches the gateway-bff routes onto the shared chi router. Called by main()
